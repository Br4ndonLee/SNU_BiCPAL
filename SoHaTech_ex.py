        ...
        while True:
            ...
            if temp_int > 21:
               ...
               #pwm.ChangeDutyCycle(0)
                ...
                print(now)
                #print(datetime.time(22,55))
                if (now > datetime.time(0,10)) and (now < datetime.time(0,20)):
                    print("GPIO 40 on")
                    GPIO.output(40, GPIO.LOW)
                else:
                    GPIO.output(40, GPIO.HIGH)
                if (now > datetime.time(4,00)) and (now < datetime.time(4,10)):
                    print("GPIO 40 on")
                    GPIO.output(40, GPIO.LOW)
                else:
                    GPIO.output(40, GPIO.HIGH)
                if (now > datetime.time(8,00)) and (now < datetime.time(8,10)):
                    print("GPIO 40 on")
                    GPIO.output(40, GPIO.LOW)
                else:
                    GPIO.output(40, GPIO.HIGH)
                if (now > datetime.time(12,00)) and (now < datetime.time(12,10)):
                    print("GPIO 40 on")
                    GPIO.output(40, GPIO.LOW)
                else:
                    GPIO.output(40, GPIO.HIGH)
                if (now > datetime.time(16,00)) and (now < datetime.time(16,10)):
                    print("GPIO 40 on")
                    GPIO.output(40, GPIO.LOW)
                else:
                    GPIO.output(40, GPIO.HIGH)
                if (now > datetime.time(20,00)) and (now < datetime.time(20,10)):
                    print("GPIO 40 on")
                    GPIO.output(40, GPIO.LOW)
                else:
                    GPIO.output(40, GPIO.HIGH)
