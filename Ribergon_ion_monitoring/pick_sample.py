...
def low_measurement():
	...
	GPIO.output(low, GPIO.HIGH); time.sleep(5)
...
def high_measurement():
	...
	GPIO.output(high, GPIO.HIGH); time.sleep(5)
...
def sample_measurement():
	...
	GPIO.output(sample, GPIO.HIGH); time.sleep(5)
...
def rinse_using_sample():
	GPIO.output(high, GPIO.LOW); time.sleep(rinse_t)
	GPIO.output(high, GPIO.HIGH); time.sleep(5)
